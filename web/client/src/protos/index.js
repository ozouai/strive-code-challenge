...
$root.quizservice = (function() {
    ...
    quizservice.QuizService = (function() {
        ...
        (QuizService.prototype = Object.create($protobuf.rpc.Service.prototype)).constructor = QuizService;
         ...
         */
        QuizService.create = function create(rpcImpl, requestDelimited, responseDelimited) {
         ...
         * @variation 1
         */
        Object.defineProperty(QuizService.prototype.listQuizes = function listQuizes(request, callback) {
            return this.rpcCall(listQuizes, $root.quizservice.ListQuizesRequest, $root.quizservice.ListQuizesResponse, request, callback);
        }, "name", { value: "ListQuizes" });
         ...
         * @variation 1
         */
        Object.defineProperty(QuizService.prototype.getQuiz = function getQuiz(request, callback) {
            return this.rpcCall(getQuiz, $root.quizservice.GetQuizRequest, $root.quizservice.GetQuizResponse, request, callback);
        }, "name", { value: "GetQuiz" });
         ...
         * @variation 1
         */
        Object.defineProperty(QuizService.prototype.submitQuiz = function submitQuiz(request, callback) {
            return this.rpcCall(submitQuiz, $root.quizservice.SubmitQuizRequest, $root.quizservice.SubmitQuizResponse, request, callback);
        }, "name", { value: "SubmitQuiz" });
         ...
         * @variation 1
         */
        Object.defineProperty(QuizService.prototype.adminCreateQuiz = function adminCreateQuiz(request, callback) {
            return this.rpcCall(adminCreateQuiz, $root.quizservice.AdminCreateQuizRequest, $root.quizservice.AdminCreateQuizResponse, request, callback);
        }, "name", { value: "AdminCreateQuiz" });
         ...
         * @variation 1
         */
        Object.defineProperty(QuizService.prototype.adminAddQuestionToQuiz = function adminAddQuestionToQuiz(request, callback) {
            return this.rpcCall(adminAddQuestionToQuiz, $root.quizservice.AdminAddQuestionToQuizRequest, $root.quizservice.AdminAddQuestionToQuizResponse, request, callback);
        }, "name", { value: "AdminAddQuestionToQuiz" });
    ...
    quizservice.SubmitQuizRequest = (function() {
        ...
        SubmitQuizRequest.encode = function encode(message, writer) {
            ...
            if (message.responses != null && message.responses.length)
                for (var i = 0; i < message.responses.length; ++i)
                    $root.quizservice.SubmitQuizRequest.Answer.encode(message.responses[i], writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SubmitQuizRequest.encodeDelimited = function encodeDelimited(message, writer) {
        ...
        SubmitQuizRequest.decode = function decode(reader, length) {
            ...
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.SubmitQuizRequest();
            while (reader.pos < end) {
                ...
                case 2:
                    if (!(message.responses && message.responses.length))
                        message.responses = [];
                    message.responses.push($root.quizservice.SubmitQuizRequest.Answer.decode(reader, reader.uint32()));
                    break;
                default:
        ...
        SubmitQuizRequest.verify = function verify(message) {
            ...
            if (message.responses != null && message.hasOwnProperty("responses")) {
                ...
                for (var i = 0; i < message.responses.length; ++i) {
                    var error = $root.quizservice.SubmitQuizRequest.Answer.verify(message.responses[i]);
                    if (error)
        ...
        SubmitQuizRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.quizservice.SubmitQuizRequest)
                return object;
            ...
            if (object.responses) {
                if (!Array.isArray(object.responses))
                    throw TypeError(".quizservice.SubmitQuizRequest.responses: array expected");
                message.responses = [];
                for (var i = 0; i < object.responses.length; ++i) {
                    if (typeof object.responses[i] !== "object")
                        throw TypeError(".quizservice.SubmitQuizRequest.responses: object expected");
                    message.responses[i] = $root.quizservice.SubmitQuizRequest.Answer.fromObject(object.responses[i]);
                }
            }
            return message;
        };
        ...
        SubmitQuizRequest.toObject = function toObject(message, options) {
            ...
            if (message.responses && message.responses.length) {
                ...
                for (var j = 0; j < message.responses.length; ++j)
                    object.responses[j] = $root.quizservice.SubmitQuizRequest.Answer.toObject(message.responses[j], options);
            }
            return object;
        };
        ...
        SubmitQuizRequest.Answer = (function() {
            ...
            Answer.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.SubmitQuizRequest.Answer();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
    ...
    quizservice.SubmitQuizResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        SubmitQuizResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        SubmitQuizResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.SubmitQuizResponse();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        SubmitQuizResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.quizservice.SubmitQuizResponse)
                return object;
    ...
    quizservice.AdminCreateQuizRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        AdminCreateQuizRequest.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        AdminCreateQuizRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.AdminCreateQuizRequest();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    quizservice.AdminCreateQuizResponse = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        AdminCreateQuizResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        AdminCreateQuizResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.AdminCreateQuizResponse();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
    ...
    quizservice.AdminAddQuestionToQuizRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        AdminAddQuestionToQuizRequest.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        AdminAddQuestionToQuizRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.AdminAddQuestionToQuizRequest();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        AdminAddQuestionToQuizRequest.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        AdminAddQuestionToQuizRequest.verify = function verify(message) {
            ...
            if (message.quizId != null && message.hasOwnProperty("quizId"))
                if (!$util.isInteger(message.quizId))
                    return "quizId: integer expected";
         ...
         * @returns {Object.<string,*>} Plain object
         */
        AdminAddQuestionToQuizRequest.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults) {
    ...
    quizservice.AdminAddQuestionToQuizResponse = (function() {
        ...
        AdminAddQuestionToQuizResponse.encode = function encode(message, writer) {
            ...
            if (message.result != null && Object.hasOwnProperty.call(message, "result"))
                $root.quizservice.Question.encode(message.result, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        AdminAddQuestionToQuizResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        AdminAddQuestionToQuizResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.AdminAddQuestionToQuizResponse();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    message.result = $root.quizservice.Question.decode(reader, reader.uint32());
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        AdminAddQuestionToQuizResponse.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        AdminAddQuestionToQuizResponse.fromObject = function fromObject(object) {
            ...
            if (object.result != null) {
                if (typeof object.result !== "object")
                    throw TypeError(".quizservice.AdminAddQuestionToQuizResponse.result: object expected");
         ...
         * @returns {Object.<string,*>} Plain object
         */
        AdminAddQuestionToQuizResponse.toObject = function toObject(message, options) {
            if (!options)
                options = {};
            var object = {};
            if (options.defaults)
                object.result = null;
            if (message.result != null && message.hasOwnProperty("result"))
                object.result = $root.quizservice.Question.toObject(message.result, options);
            return object;
        };
    ...
    quizservice.ListQuizesRequest = (function() {
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ListQuizesRequest.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        ListQuizesRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.ListQuizesRequest();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                default:
        ...
        ListQuizesRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.quizservice.ListQuizesRequest)
                return object;
    ...
    quizservice.ListQuizesResponse = (function() {
        ...
        ListQuizesResponse.encode = function encode(message, writer) {
            ...
            if (message.quizes != null && message.quizes.length)
                for (var i = 0; i < message.quizes.length; ++i)
                    $root.quizservice.ListQuizesResponse.Entry.encode(message.quizes[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        ListQuizesResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        ListQuizesResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.ListQuizesResponse();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    if (!(message.quizes && message.quizes.length))
                        message.quizes = [];
                    message.quizes.push($root.quizservice.ListQuizesResponse.Entry.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        ListQuizesResponse.verify = function verify(message) {
            ...
            if (message.quizes != null && message.hasOwnProperty("quizes")) {
                if (!Array.isArray(message.quizes))
                    return "quizes: array expected";
                for (var i = 0; i < message.quizes.length; ++i) {
                    var error = $root.quizservice.ListQuizesResponse.Entry.verify(message.quizes[i]);
                    if (error)
                        return "quizes." + error;
                }
            }
        ...
        ListQuizesResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.quizservice.ListQuizesResponse)
                return object;
            var message = new $root.quizservice.ListQuizesResponse();
            if (object.quizes) {
                if (!Array.isArray(object.quizes))
                    throw TypeError(".quizservice.ListQuizesResponse.quizes: array expected");
                message.quizes = [];
                for (var i = 0; i < object.quizes.length; ++i) {
                    if (typeof object.quizes[i] !== "object")
                        throw TypeError(".quizservice.ListQuizesResponse.quizes: object expected");
                    message.quizes[i] = $root.quizservice.ListQuizesResponse.Entry.fromObject(object.quizes[i]);
                }
            }
            return message;
        };
        ...
        ListQuizesResponse.toObject = function toObject(message, options) {
            ...
            if (message.quizes && message.quizes.length) {
                ...
                for (var j = 0; j < message.quizes.length; ++j)
                    object.quizes[j] = $root.quizservice.ListQuizesResponse.Entry.toObject(message.quizes[j], options);
            }
            return object;
        };
        ...
        ListQuizesResponse.Entry = (function() {
            ...
            Entry.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.ListQuizesResponse.Entry();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
    ...
    quizservice.GetQuizRequest = (function() {
         ...
         * @instance
         */
        GetQuizRequest.prototype.id = $util.Long ? $util.Long.fromBits(0,0,true) : 0;
        ...
        GetQuizRequest.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.GetQuizRequest();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        GetQuizRequest.fromObject = function fromObject(object) {
            if (object instanceof $root.quizservice.GetQuizRequest)
                return object;
    ...
    quizservice.GetQuizResponse = (function() {
        ...
        GetQuizResponse.encode = function encode(message, writer) {
            ...
            if (message.questions != null && message.questions.length)
                for (var i = 0; i < message.questions.length; ++i)
                    $root.quizservice.Question.encode(message.questions[i], writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
         ...
         * @returns {$protobuf.Writer} Writer
         */
        GetQuizResponse.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };
        ...
        GetQuizResponse.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.GetQuizResponse();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
                    if (!(message.questions && message.questions.length))
                        message.questions = [];
                    message.questions.push($root.quizservice.Question.decode(reader, reader.uint32()));
                    break;
                default:
                    reader.skipType(tag & 7);
                    break;
        ...
        GetQuizResponse.fromObject = function fromObject(object) {
            if (object instanceof $root.quizservice.GetQuizResponse)
                return object;
            var message = new $root.quizservice.GetQuizResponse();
            if (object.questions) {
                if (!Array.isArray(object.questions))
                    throw TypeError(".quizservice.GetQuizResponse.questions: array expected");
                message.questions = [];
                for (var i = 0; i < object.questions.length; ++i) {
                    if (typeof object.questions[i] !== "object")
                        throw TypeError(".quizservice.GetQuizResponse.questions: object expected");
                    message.questions[i] = $root.quizservice.Question.fromObject(object.questions[i]);
                }
            }
            return message;
        };
        ...
        GetQuizResponse.toObject = function toObject(message, options) {
            ...
            if (message.questions && message.questions.length) {
                ...
                for (var j = 0; j < message.questions.length; ++j)
                    object.questions[j] = $root.quizservice.Question.toObject(message.questions[j], options);
            }
            return object;
        };
    ...
    quizservice.Question = (function() {
        ...
        Question.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.quizservice.Question();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1:
        ...
        Question.fromObject = function fromObject(object) {
            if (object instanceof $root.quizservice.Question)
                return object;
